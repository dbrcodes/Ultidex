...
CREATE TABLE `kanto` (
  ...
  KEY `type1` (`type1`),
  KEY `type2` (`type2`),
  CONSTRAINT `kanto_ibfk_1` FOREIGN KEY (`type1`) REFERENCES `types` (`id`),
  CONSTRAINT `kanto_ibfk_2` FOREIGN KEY (`type2`) REFERENCES `types` (`id`)
...
-- Dump completed on 2023-08-02 14:47:37
